...
When you're done with Jupyter, you can close it by clicking on the `Quit` button in the main window of Jupyter. Every time you want to work on this project, you will need to open a Terminal, and run:
