...
Computation of elliptic Lagrangian diffusion barriers [1,3] using the null-geodesics algorithm introduced by [2].

The demo is inside the folder "Main":

_"EllipticLagrangianDiffusionBarriersAgulhas": Elliptic Lagrangian diffusion barriers demo applied to AVISO data set in Agulhas region.
...
[3] Notebook 8.1. in "Transport Barriers and Coherent Structures in Flow Data" by Prof. George Haller.
