...
Computation of TSE [1,2]

The demo is inside the folder "Main":

_"TSEABCsteady": TSE demo applied to steady ABC-flow.
_"TSEABCunsteady": TSE demo applied to unsteady ABC-flow.

Auxiliary functions in current folder:

_"TSE": computes TSE from velocity along particle trajectories.
