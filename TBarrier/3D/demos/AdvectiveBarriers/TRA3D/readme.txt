...
_"TRAABCsteady": TRA demo applied to steady ABC-flow.
_"TRAABCunsteady": TRA demo applied to unsteady ABC-flow.

Auxiliary functions in current folder:

_"TRA": computes TRA from velocity along particle trajectories.
